...
<jsp:useBean id="produto" class="cadastro.ProdutoEntrada" scope="page"></jsp:useBean>

<jsp:useBean id="produtoEstoque" class="cadastro.ProdutoEntradaEstoque" scope="page"></jsp:useBean>
...
if(request.getParameter("nome") != null){
	...
	rs = st.executeQuery(produtoEstoque.pesquisaEntrada());
}
 ...
 <br />
  ...
  <%} %>
   ...
   <tr bgcolor="#EEEEEE">
    ...
    <td width="160" align="left"><strong></strong></td>
...
%>
   ...
   <tr>
    ...
    <td width="160" height="30" align="left"></td>
    ...
    <td width="60" align="center"><!-- a href="sis_insert_estoque.jsp?produtoID=<%=rs.getString("produtoID")%>&tipo=1"><img src="ico/ico_estoque.png" width="20" height="20" border="0" title="Alimentar Estoque de <%=rs.getString("nome")%>" /></a--></td>
