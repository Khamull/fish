...
ResultSet rs01 = null;
ResultSet rs02 = null;
String trasnfID = request.getParameter("transfID");
%>
...
if(!trasnfID.equals(""))
{
	response.sendRedirect("relatorios/rel_retorno_feira.jsp?transfID="+trasnfID);//Caso der algum problema é só comentar essa linha que irá aparecer na tela todas as informações do Pagamento da Compra
}
else
{
