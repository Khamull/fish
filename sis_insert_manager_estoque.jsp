...
if(request.getParameter("fornecedorID") != null && request.getParameter("fornecedorID") != "")
{
	estoque.fornecedor.fornecedorID = Integer.parseInt(request.getParameter("fornecedorID"));
}
else
{
