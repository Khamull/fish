...
--
-- Host: 127.0.0.1
-- Generation Time: 20-Nov-2014 às 18:07
...
`retiradaID` int(11) NOT NULL,
  `produtoID` int(11) NOT NULL,
  `destinoID` int(11) NOT NULL DEFAULT '0',
  `quantidade` float(10,2) NOT NULL,
  `qtdFim` float(10,2) NOT NULL DEFAULT '0.00',
  `perda` float(10,2) NOT NULL DEFAULT '0.00',
  `motivo` text,
  `usuario` varchar(100) NOT NULL,
...
ALTER TABLE `transferenciaestoque`
 ADD PRIMARY KEY (`transferenciaID`), ADD KEY `tipo` (`tipo`);
...
--
ALTER TABLE `caixa`
MODIFY `caixaID` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `estoque`
MODIFY `estoqueID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `lancamentos`
MODIFY `lancamentoID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `produtoestoque`
MODIFY `produtoestoqueID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `receber`
--
ALTER TABLE `receber`
MODIFY `receberID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
...
--
ALTER TABLE `servicofechado`
MODIFY `servicofechadoID` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tipoproduto`
MODIFY `tipoprodutoID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
