...
%>
	...
	<script type="text/javascript">
	 ...
	 window.location.href="sis_transferencia_feira.jsp";
	</script>
...
<%}else{
	...
	transferencia.produto.produtoID = Integer.parseInt(pID);
	st.execute(transferencia.salvaTransferenciaFeira());
}
%>
...
if(transferido){
	response.sendRedirect("sis_transferencia_feira.jsp?msg=6");
}
%>
