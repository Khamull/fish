...
public class Venda {
	...
	public int feiranteID;
	

	
	//verifica se já existe uma venda Aberta com esse usuário de sistema
	public String vendaAberta() {
		return "SELECT * FROM venda WHERE status = '1' AND usuario = '"+usuario.login+"'  ORDER BY data DESC LIMIT 1";
	}
	...
	public String clienteVendaIDfeira() {
		String cliente = "SELECT empresa.* , venda.* FROM venda LEFT JOIN empresa ON empresa.empresaID = venda.clienteID WHERE venda.vendaID = '"+vendaID+"'"; 
		return cliente;
	}
	...
	public String cadastraVendaRetorno(){//Cadastra venda para retorno Feira
		String insere = "INSERT INTO venda (clienteID, formPagID, vezes, valor, entrada, troco, desconto, notaFiscal, usuario, empresaID) ";
		insere += "VALUES ('"+feiranteID+"', '0', '0', '0', '0', '0', '0', '0', '"+usuario.login+"', '"+empresa.empresaID+"')";
