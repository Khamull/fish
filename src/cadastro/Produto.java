...
public class Produto {
	...
	public String listaProdutos() {
		...
		String pesquisaProduto = "SELECT tipoproduto.tipoprodutoID, tipoproduto.tipo, produto.* ";
	...
	public String produtoPorID() {
		String porID = "SELECT * FROM produto WHERE produtoID = '"+produtoID+"'";
		return porID;
	}
	...
	public String salvaProduto() {
		...
		String salvaProd = "INSERT INTO produto ";
		salvaProd += "(tipoprodutoID,  nome, codigo, unidade, precoCusto, preco, estoqueminimo, estoque, lucro) VALUES";
		salvaProd += "('"+tipo.tipoProdutoID+"', '"+nome+"', '"+codigo+"', '"+unidade+"', '"+precoCusto+"', '"+preco+"', '"+estoqueMinimo+"', '"+estoque+"', '"+lucro+"' ) ";
		return salvaProd;
	}
	...
	public String alteraEstoqueProduto() {
		String estoque_ = "UPDATE produto SET estoque = '"+estoque+"' WHERE produtoID = '"+produtoID+"'";
		return estoque_;
	}
