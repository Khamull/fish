...
<%
//Pesquisa Cliente da Venda
venda.vendaID = Integer.parseInt(request.getParameter("vendaID"));
rs02 = st02.executeQuery(venda.clienteVendaIDfeira());
%>
...
<!--INICIO DO FORMULÁRIO DE VENDAS-->
 <form name="form1" method="post" action="sis_insert_manager_venda.jsp?transfID=<%=transfID %>" id="form1" onSubmit="return verForm(this)">
         ...
         <tr>
          ...
          <td align="left" colspan="2" valign="middle" background="images/label365.png" style="background-repeat:no-repeat">
            <select name="clienteID" class="selectPDV">
             ...
             <%if(rs02.next()){ %>
              <option value="<%=rs02.getString("empresaID") %>" selected="selected"><%=rs02.getString("unidade") %></option>
             <%} %>
            </select>
          </td>
         </tr>
